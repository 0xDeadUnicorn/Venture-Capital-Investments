...
|-------------|-------------|-------------|-------------|-------------|-------------|-------------|
| Farcaster | Paradigm(Lead)<br>a16z(Lead) | [$180M](https://crypto-fundraising.info/projects/farcaster/) | Social | Farcaster is a sufficiently decentralized social network built on Ethereum. It is an open protocol that supports multiple clients, like email, allowing seamless interaction across platforms while prioritizing user autonomy and data ownership. | [Site](https://www.farcaster.xyz/)<br>[Twitter](https://twitter.com/farcaster_xyz) | - |
